...
sell_data['inserts'] = 'INSERT INTO SELL_DATA VALUES (' + sell_data['Cena'].astype(str) + ", '" + sell_data['Miasto'] + "','" + sell_data['Dzielnica'] + \
...
rent_data['inserts'] = 'INSERT INTO RENT_DATA VALUES (' + rent_data['Cena'].astype(str) + ", '" + rent_data['Miasto'] + "','" + rent_data['Dzielnica'] + \
